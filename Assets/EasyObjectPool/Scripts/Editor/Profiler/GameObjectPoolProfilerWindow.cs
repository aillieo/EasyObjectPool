...
{
    public class GameObjectPoolProfilerWindow : EditorWindow
    {
        [MenuItem("AillieoUtils/EasyObjectPool/GameObjectPool/Profiler")]
        public static void Open()
        {
            GetWindow<GameObjectPoolProfilerWindow>("GameObjectPool Profiler");
        }
